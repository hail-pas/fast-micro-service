...
from script.menu_and_perm.data import MenuAndPerm
from storages.relational.models.user_center import Account, Resource, Permission
...
async def update_or_create_perm_code(app: ServiceApi) -> None:
    latest_codes = set()
...
async def main():
    await init_ctx()
    await permission_init(app=factory.service_api)
