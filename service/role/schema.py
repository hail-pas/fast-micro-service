...
from common.pydantic import as_query, optional
...
class RoleUpdate(
    ...
    resources: list[int] = Field(None, description="系统资源")


@as_query
class RoleFilterSchema(BaseModel):
    label: str = Field(None, description="名称")
    accounts__phone: str = Field(None, max_length=11, description="电话")
    accounts__username: str = Field(None, max_length=20, description="账号")
