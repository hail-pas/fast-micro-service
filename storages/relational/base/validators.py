...
RE_PHONE_TYPE = Annotated[
    str, AfterValidator(RegexValidator(PHONE_REGEX_CN, 0, default_ctx={"field_name": "手机号"}))
]
RE_EMAIL_TYPE = Annotated[str, AfterValidator(RegexValidator(EMAIL_REGEX, 0, default_ctx={"field_name": "邮箱"}))]
